...
import {demoFilledDonut} from "./demoFilledDonut.js"
...
export let scenes = function () {
    ...
    if (demoDemoFilledDonutState % 2) loadDemo(demoFilledDonut); else stopDemo(demoFilledDonut);
}
...
window.demoNames = "DemoCube,DemoFilledDonut";
